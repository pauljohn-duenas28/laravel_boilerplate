...
class CreatePunchEventMaterialsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('punch_event_materials', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('punch_event_materials');
    }
}
